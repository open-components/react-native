...
import backIcon from '../resource/images/backIcon.png';//返回按钮
import scanLine from '../resource/images/scan_line.png';//扫描线
                                ...
                                <View style={styles.bottomContainer}>
                                    ...
                                    <TouchableOpacity onPress={this._changeFlash}>
                                        <View style={styles.flash}>
                                            <Image style={{width:SCALE(100),height:SCALE(100)}} source={require('../resource/images/ic_flash.png')}></Image>
